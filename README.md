The AWS credent5a3s have been set as environment values fro AWS key and aws secret
using this example -https://blog.kubesimplify.com/building-apigateway-with-lambda-using-pulumi

Process is
Create AWS credentials
Create an AWS S3 as the state file - danieldoranpulumi.state
pulumi up - this will create a new S3 bucket : "my-bucket" 
